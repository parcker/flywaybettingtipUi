...
/* Vue.js Extension {{row.DateValue | formatDateTime}} */
Vue.filter('formatDate', function (value) { if (value) {  return moment(String(value)).format('DD/MM/YYYY');   } });
Vue.filter('formatDateTime', function (value) { if (value) { return moment(String(value)).format('DD/MM/YYYY hh:mm:ss'); } });
...
var API_URL = "http://flywaytips.herokuapp.com";    